...
namespace PastebookDataLibrary
{
    ...
    public partial class DB_PASTEBOOKEntities : DbContext
    {
        ...
        public virtual ObjectResult<SP_TIMELINE_Result> SP_TIMELINE(Nullable<int> userID)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("userID", userID) :
                new ObjectParameter("userID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_TIMELINE_Result>("SP_TIMELINE", userIDParameter);
        }
