...
namespace Pastebook.Manager
{
    ...
    //    public bool LikeOrUnlikePost(LikeViewModel like)
    //    {
    //        bool returnValue = false;
    //        returnValue = dA.CreateOrDeleteLike(MVCMapper.MapLikeModelToLikeEntity(like));
    //        return returnValue;
    //    }

    //    public List<LikeViewModel> GetPostLikes(int postID)
    //    {
    //        List<LikeViewModel> likeList = new List<LikeViewModel>();
    //        var getLikes = dA.RetrieveLikes(postID);
    //        foreach (var like in getLikes)
    //        {
    //            likeList.Add(MVCMapper.MapLikeEntityToLikeModel(like));
    //        }
    //        return likeList;
    //    }
